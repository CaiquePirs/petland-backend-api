...
class GenerateSaleResponseTest {

    private final GenerateSaleResponse generateSaleResponse = new GenerateSaleResponse();
    ...
    void shouldGenerateSaleResponseWithAllValues() {
        ...
        SaleResponseDTO response = generateSaleResponse.generateSaleResponse(sale);
