package com.petland.modules.customer.controller.doc;
...
public interface AuthCustomerApi {
            ...
            @ApiResponse(
                            ...
                            examples = @ExampleObject(value = """
                    {
                      ...
                      "errors": [
                        ...
                        { "field": "password", "message": "Password must be up to 8 characters" },
                        { "field": "phone", "message": "Phone is required" },
                        { "field": "dateBirth", "message": "The date cannot be in the future" },
                        { "field": "dateBirth", "message": "DateBirth is required" },
    ...
    ResponseEntity<CustomerResponseDTO> register(@RequestBody @Valid CustomerRequestDTO customerRequestDTO);
